const Map<String, String> en_US = {
  ...
  "TransferWaring":
      'Currently, the EdDSA private keys exported by Solana, Aptos, and Polkadot do not support wallet import. If you need to transfer money, you can use the EdDSA transfer tool through the restored private key.',
  "TransferWaring2":
      '1. Please check the balance when transferring out to ensure that the transferred tokens and gas fee are sufficient to avoid the problem. \n2. To avoid losing the asset, the amount of DOT to be transferred must be > 1.',
  ...
  "TransferDeclaration": 'Note: Confirming the transfer means you agree to the client\'s online broadcast transaction.',
  "Declaration1": 'Confirming the transfer means that you agree to the client’s online operation for on-chain broadcast.',
  "Declaration2":
      '2. For offline signature, it will generate a signed message code on the client side. Please copy the message code and entrust a third party to perform the on-chain broadcast transaction.',
  "BlockExplorer": 'Please copy the address and go to the block browser to check >',
  ...
  "copy": 'Copied',
  "recovery_waring": "Note: Click \"Generate all private keys\", the client will generate the sub-private key and corresponding address of the specified chain offline",
  "recovery_waring1":
