...
class NewPopupWindow {
  ...
  static void create(
    ...
    double widgetCenter = 0.0;
    double widgetRight = 0.0;
    switch (direction) {
      case WindowDirection.bottom: //下面
        widgetTop = size.bottom + margin;
        widgetLeft =
            size.right - childWidth / 2 - (size.right - size.left) - offLeft;
        print("widgetLeft:$widgetLeft");
        break;
      case WindowDirection.left: //左面
        widgetTop =
            size.bottom ;
        widgetLeft = size.left - childWidth - margin - offLeft;
        break;
      ...
      case WindowDirection.bottomRight: //右下
        widgetTop = size.bottom + margin;
        widgetLeft = size.right + margin - childWidth - offLeft;
        print("widgetLeft:$widgetLeft");
        break;
    ...
    if (_overlayEntry == null) {
      ...
      _overlayEntry = OverlayEntry(
          builder: (BuildContext context) => GestureDetector(
              ...
              child: Container(
                  margin: EdgeInsets.only(top: widgetTop,left: widgetLeft),
