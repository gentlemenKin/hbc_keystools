        ...
        children: [
          ...
          Column(
            children: [
              ...
              SizedBox(height: 12,),
              Text('Failed'.tr, style: TextStyle(color: ColorConstant.color_0xff333333, fontSize: 18, fontWeight: FontWeight.w400,),),
              SizedBox(height: 8,),
              Text(msg, style: TextStyle(color: ColorConstant.color_0xff999999, fontSize: 14, fontWeight: FontWeight.w300,),),
              SizedBox(height: 32,),
