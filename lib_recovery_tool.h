...
extern RSResult GoTransfer(GoString chain, GoString url, GoString privkey, GoString toAddr, GoString amount, GoString coinAddress, GoString language, GoString memo);
